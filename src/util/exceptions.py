...
class StaffNotFound(AkashiException):
    def __init__(self, message="Sorry, I couldn't find that staffmember. Please check for proper capitalization."):
        self.message = message
...
class ProjectNotFound(AkashiException):
    def __init__(self, message="Sorry, this project doesn't appear to be in my database."):
        self.message = message
